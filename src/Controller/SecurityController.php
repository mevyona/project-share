...
class SecurityController extends AbstractController
{
    ...
    public function changePassword(Request $request, EntityManagerInterface $em, UserPasswordHasherInterface $hasher, ValidatorInterface $validator, ActivityLogger $activityLogger): Response
    {
